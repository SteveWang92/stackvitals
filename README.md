...
[![Deploy site](https://github.com/SteveWang92/stackvitals/actions/workflows/deploy-site.yml/badge.svg)](https://github.com/SteveWang92/stackvitals/actions/workflows/deploy-site.yml)
...
2. Copy `.env.example` to `.env` and fill in `VITE_SUPABASE_URL` / `VITE_SUPABASE_ANON_KEY` /
   `VITE_DASHBOARD_ALLOWED_EMAIL` (and `HUB_SUPABASE_JWT_SERVICE_ROLE_KEY` for the collector).

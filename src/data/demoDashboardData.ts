...
const acmeSite: ProjectStatus = {
  ...
  providers: [
    ...
    },
    {
      ...
      label: 'Resend',
      status: 'warning',
      detail: 'Sending domain mail.example.dev is pending verification.',
      lastSync: hoursAgo(3),
      freshness: 'fresh',
    },
    {
  ...
  recentSnapshots: [
    ...
    { label: 'Resend Domain Verified', provider: 'resend', status: 'warning', value: '0', collectedAt: hoursAgo(3) },
  ],
  collectorErrors: [],
...
export const demoDashboardData: DashboardData = {
  ...
  collectorRuns: [
    ...
    },
    {
      ...
      status: 'success',
      summary: '1/1 Resend domains collected.',
      errorMessage: null,
      startedAt: hoursAgo(3),
      finishedAt: hoursAgo(3),
      lastSyncedAt: hoursAgo(3),
